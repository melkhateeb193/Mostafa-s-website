...
function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_9wr60k8', 'template_15q3uxd', formRef.current, {
            publicKey: '4Me9dwZ86ehHQsrqT',
          })
          .then(
            () => {
              console.log('SUCCESS!');
    ...
    <motion.div className="contact" ref={ref} variants={variants} initial="initial" whileInView={"animate"}> 
        <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Mail</h2>
                <span>mostafamagdy8800@gmail</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>address</h2>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Phone</h2>
                <span>+201111700513</span><br/>
                <span>+201093711099</span>
            </motion.div>
        </motion.div>
